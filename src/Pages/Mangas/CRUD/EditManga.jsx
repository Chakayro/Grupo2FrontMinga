...
const tealButtonClasses = "w-full bg-teal-400 hover:bg-teal-500 text-white font-semibold py-4 px-4 rounded-full transition-colors shadow-md text-xl";
const pinkButtonClasses = "w-full bg-pink-100 hover:bg-pink-200 text-orange-400 font-semibold py-4 px-4 rounded-full transition-colors shadow-md text-xl";
const pageTitleClasses = "text-3xl font-semibold text-gray-600 text-center mb-14";
