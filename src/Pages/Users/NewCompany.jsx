...
const formInputClasses = "w-full p-2 pl-1 border-b-2 border-gray-300 focus:border-teal-500 bg-transparent focus:outline-none transition-colors text-sm placeholder-gray-400";
...
const pageTitleClasses = "text-4xl  text-gray-800 text-center mb-13";
...
function NewCompany() {
  ...
  return (
    <div className="min-h-full flex flex-col items-center justify-center p-30 bg-gray-100">
